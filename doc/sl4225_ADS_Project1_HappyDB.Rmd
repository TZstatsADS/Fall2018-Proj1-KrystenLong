...
```{r}
#delete meaningless words like "day, time, finally"
word_count <- word_count[c(-2,-3,-9),]
wordcloud2(word_count,size =0.5,shape = 'triangle')
```
...
```{r}
wordcloud2(word_count_bigrams,size =0.3,shape = 'triangle')
```
...
#plot wordcloud
wordcloud2(word_count_3,size =0.5,shape = 'triangle')
wordcloud2(word_count_24,size =0.5,shape = 'triangle')
...
wordcloud2(word_count_bigrams_3,size =0.3,shape = 'triangle')
```
...
wordcloud2(word_count_bigrams_24,size =0.3,shape = 'triangle')
```
